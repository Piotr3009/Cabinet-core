...
import {
  FRONT_STYLE_OPTIONS, colourLabel, finishById, migrateDesign, projectHeights, projectSheen,
  resolveJoinery, roughnessFromSheen, sheenLabel, sheenSteps,
 ...
 */
function SheenSlider({ design, setDesign, profile }) {
