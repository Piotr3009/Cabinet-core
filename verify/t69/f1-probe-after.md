...
_The law on disk when this ran: APPLY sends **ONLY THE KEYS THE WINDOW CHANGED**, and the button **IS ALWAYS LIVE**._
...
| 4 · wall 1 typed 4200, a window added underneath first | 3000×3000, h 2500 | 4200×3000, h 2500 | ok | 4200×3000, h 2500 | YES | 1 |
| 5 · height typed 2700, a window added underneath first | 3000×3000, h 2500 | 3000×3000, h 2700 | ok | 3000×3000, h 2700 | YES | 1 |

**VERDICT — 0 of 5 edits do not reach the store;** **0 of 2 runs with a live write underneath LOSE that write.**
...
| --- | --- | --- | --- | --- |
| 6 · a 2000 wardrobe stands; the wall is dragged to 1800 | 1800x3000, h 2500 | live | Cannot shrink the room below placed units — move or remove units first (W01). | **no** |
| 7 · a 2400-tall wardrobe stands; the ceiling is typed 2200 | 4000x3000, h 2200 | live | Cannot shrink the room below placed units — move or remove units first (W01). | **no** |
| 8 · RECTANGLE pressed on a room that already is one | 4000x3000, h 2500 | live | applied | **no** |

**VERDICT 2 — 0 of 3 states leave APPLY dead, and a dead button authors no sentence: `roomChangeGuard`'s message is written and never read.**
