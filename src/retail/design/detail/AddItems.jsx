...
export default function AddItems({ unit, onDone = null, onZoneHover = null }) {
  ...
  return (
    <div className="pbi-re-stack-1" data-add-items="1">
      {shown.map((kind) => (
        <div key={kind.id}>
          <button
            type="button"
            ...
            className={`pbi-re-wfull pbi-re-row pbi-re-mid pbi-re-gap-2 pbi-re-px2 pbi-re-py15 pbi-re-round pbi-re-tsm pbi-re-left pbi-re-fade
              pbi-re-dis-dim pbi-re-dis-nope pbi-re-fill-hover-en ${
          ...
          >
            <span className="pbi-re-grow">{kind.label}</span>
            {kind.soon && <span className="pbi-re-tag">soon</span>}
            {kind.disabled && !kind.soon && <span className="pbi-re-t10 pbi-re-quiet">{kind.why}</span>}
            {!kind.disabled && <span className="pbi-re-quiet pbi-re-t10" aria-hidden>{addItemKind === kind.id ? '▾' : '▸'}</span>}
          </button>

          {addItemKind === kind.id && !kind.disabled && (
            <div className="pbi-re-mt1 pbi-re-mb2 pbi-re-ml2 pbi-re-pl2 pbi-re-line-l pbi-re-hair pbi-re-stack-2">
              {kind.id === 'drawers' && (
                <>
                  ...
                  {zones.length > 1 && (
                    <div className="pbi-re-stack-1">
                      <span className="pbi-re-fieldlabel">Which column</span>
                      <div className="pbi-re-row pbi-re-wrap pbi-re-gap-1">
                        {zones.map((z) => (
                          <button
                            ...
                            className={`pbi-re-btn pbi-re-px2 ${drawerZone === z.index ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                      ...
                      {drawerZone == null && (
                        <p className="pbi-re-t11 pbi-re-gold">
                          This cabinet is divided — pick the column the drawers go in.
                        </p>
                      )}
                    </div>
                  )}
                  <div className="pbi-re-row pbi-re-bottom pbi-re-gap-2">
                    <div className="pbi-re-w16">
                      <span className="pbi-re-fieldlabel">Count</span>
                      <NumberField min={1} max={DR.maxCount} value={drawerCount} onCommit={setDrawerCount} />
                    </div>
                    <div className="pbi-re-w20">
                      <span className="pbi-re-fieldlabel">Height</span>
                      <NumberField
                  ...
                  <div className="pbi-re-row pbi-re-gap-1">
                    <button
                      ...
                      className={`pbi-re-btn pbi-re-grow ${drawerMount === 'overlay' ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                    ...
                    <button
                      ...
                      className={`pbi-re-btn pbi-re-grow ${drawerMount === 'internal' ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                    ...
                    <div className="pbi-re-row pbi-re-gap-1 pbi-re-wrap">
                      {[
                        ...
                        <button
                          ...
                          className={`pbi-re-btn pbi-re-px2 pbi-re-t11 ${drawerVariant === id ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                          title={hint}
              ...
              {kind.id === 'shoe_box' && (
                <>
                  {zones.length > 1 && (
                    <div className="pbi-re-stack-1">
                      <span className="pbi-re-fieldlabel">Which bay</span>
                      <div className="pbi-re-row pbi-re-wrap pbi-re-gap-1">
                        {zones.map((z) => (
                          <button
                            key={z.id}
                            ...
                            className={`pbi-re-btn pbi-re-px2 ${shoeBoxZone === z.index ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                            title={`${formatMm(z.size)} mm clear`}
                            onPointerEnter={() => onZoneHover?.(z.index)}
              ...
              {kind.id === 'shelves' && (
                <>
                  ...
                  {zones.length > 1 && (
                    <div className="pbi-re-stack-1">
                      <span className="pbi-re-fieldlabel">Which side</span>
                      <div className="pbi-re-row pbi-re-wrap pbi-re-gap-1">
                        {zones.map((z) => (
                          <button
                            key={z.id}
                            type="button"
                            data-zone={z.index}
                            className={`pbi-re-btn pbi-re-px2 ${shelfZone === z.index ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                            title={`${formatMm(z.size)} mm clear`}
                            onPointerEnter={() => onZoneHover?.(z.index)}
                  ...
                  <div className="pbi-re-row pbi-re-bottom pbi-re-gap-2">
                    <div className="pbi-re-w16">
                      <span className="pbi-re-fieldlabel">Add</span>
              ...
              {kind.id === 'partition' && (
                <>
                  <button type="button" className="pbi-re-btn-gold pbi-re-wfull" onClick={onAddPartition}>
              ...
              {kind.id === 'hanger' && (
                <>
                      ...
                      <div className="pbi-re-row pbi-re-wrap pbi-re-gap-1">
                        {zones.map((z) => (
                          <button
                            ...
                            className={`pbi-re-btn pbi-re-px2 ${railZone === z.index ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                            title={`${formatMm(z.size)} mm clear`}
                            onPointerEnter={() => onZoneHover?.(z.index)}
                  ...
                  <div>
                    <span className="pbi-re-fieldlabel">Rail (hardware)</span>
                    <select
                  ...
                  <div className="pbi-re-row pbi-re-gap-1" data-rail-mode={railWithShelf ? 'with-shelf' : 'alone'}>
                    <button
                      type="button"
                      data-rail-with-shelf="1"
                      aria-pressed={railWithShelf}
                      className={`pbi-re-btn pbi-re-grow ${railWithShelf ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                  ...
                  <button
                    type="button" className="pbi-re-btn-gold pbi-re-wfull"
                  ...
                  <p className="pbi-re-t11 pbi-re-quiet" data-rail-assembly-hint="1">
                    {railWithShelf
              ...
              {['pulldown', 'trouser', 'tie_rack'].includes(kind.id) && (() => {
                ...
                return (
                  <>
                        ...
                        <div className="pbi-re-row pbi-re-wrap pbi-re-gap-1">
                          {zones.map((z) => (
                            <button
                              ...
                              className={`pbi-re-btn pbi-re-px2 ${kitZone === z.index ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                              title={`${formatMm(z.size)} mm clear`}
                              onPointerEnter={() => onZoneHover?.(z.index)}
                    ...
                    {kind.id === 'pulldown' && (
                      <label className="pbi-re-stack-1 pbi-re-block">
                        <span className="pbi-re-fieldlabel">Rod from top (mm)</span>
                        <input
                          type="number"
      ...
      <button
        type="button"
        className="pbi-re-wfull pbi-re-left pbi-re-px2 pbi-re-py1 pbi-re-t11 pbi-re-quiet pbi-re-gold-hover pbi-re-fade"
