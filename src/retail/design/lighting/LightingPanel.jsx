...
function LightArt({ kind }) {
  ...
  if (kind === 'shelf') {
    return (
      <svg width="72" height="44" viewBox="0 0 72 44" fill="none" aria-hidden className="pbi-re-dim80 pbi-re-nogrow">
...
export default function LightingPanel() {
  ...
  return (
    <Modal
      ...
      sticky
    >
      <div data-lighting-panel="1" className="pbi-re-stack-3">
        ...
        <div className="pbi-re-row pbi-re-gap-2" data-lighting-onoff="1">
          <button
            type="button"
            data-lighting-on
            ...
            className={`pbi-re-grow pbi-re-h11 pbi-re-round pbi-re-line pbi-re-tbase pbi-re-semibold pbi-re-track ${
              lighting.on
                ? 'pbi-re-fill-on pbi-re-hair-ok pbi-re-on-dark'
                : 'pbi-re-hair pbi-re-quiet pbi-re-hair-hover'
            }`}
          ...
          <button
            ...
            className={`pbi-re-grow pbi-re-h11 pbi-re-round pbi-re-line pbi-re-tbase pbi-re-semibold pbi-re-track ${
              lighting.on
                ? 'pbi-re-hair pbi-re-quiet pbi-re-hair-hover'
                : 'pbi-re-fill-bad-solid pbi-re-hair-bad pbi-re-on-dark'
            }`}
        ...
        <p className="pbi-re-t10 pbi-re-quiet" data-lighting-preview-note="1">
        ...
        <>
            ...
            <div className="pbi-re-stack-1">
              <span className="pbi-re-t11 pbi-re-caps pbi-re-track pbi-re-quiet">Colour temperature</span>
              <div className="pbi-re-row pbi-re-gap-1">
                {spec.temperatures.map((t) => (
                  <button
                    key={t.k}
                    type="button"
                    className={`pbi-re-btn pbi-re-px2 pbi-re-t11 ${lighting.temperature === t.k ? 'pbi-re-hair-gold pbi-re-ink' : ''}`}
            ...
            <div className="pbi-re-stack-1">
              <span className="pbi-re-t11 pbi-re-caps pbi-re-track pbi-re-quiet">Switching</span>
              <div className="pbi-re-row pbi-re-gap-1">
                {switches.map((c) => (
                  <button
                    key={c.id}
                    type="button"
                    className={`pbi-re-btn pbi-re-px2 pbi-re-t11 ${lighting.switch === c.id ? 'pbi-re-hair-gold pbi-re-ink' : ''}`}
            ...
            {/* ─── placements ───────────────────────────────────────────── */}
            <div className="pbi-re-stack-2 pbi-re-pt1 pbi-re-line-t pbi-re-hair">
              <span className="pbi-re-t11 pbi-re-caps pbi-re-track pbi-re-gold">Place a light</span>

              {/* the owner's shelf flow: a REAL click on a shelf in the scene */}
              <div className="pbi-re-row pbi-re-top pbi-re-gap-2" data-lighting-tool="shelf">
                <LightArt kind="shelf" />
                <div className="pbi-re-grow pbi-re-stack-1">
                  <span className="pbi-re-t11 pbi-re-ink-1">{KIND_WORDS.shelf}</span>
                  {shelfPanel && (
                    <button
                      type="button"
                      className="pbi-re-btn pbi-re-wfull pbi-re-t11"
              ...
              {unit ? (
                <>
                  <div className="pbi-re-row pbi-re-top pbi-re-gap-2" data-lighting-tool="side">
                    <LightArt kind="side" />
                    <div className="pbi-re-grow pbi-re-stack-1">
                      <span className="pbi-re-t11 pbi-re-ink-1">{KIND_WORDS.side} · {unit.params.unit_num}</span>
                      <div className="pbi-re-row pbi-re-gap-1">
                        {['L', 'R'].map((side) => (
                          <button
                            key={side}
                            type="button"
                            className="pbi-re-btn pbi-re-px2 pbi-re-t11 pbi-re-grow"
                  ...
                  <div className="pbi-re-row pbi-re-top pbi-re-gap-2" data-lighting-tool="bottom">
                    <LightArt kind="bottom" />
                    <div className="pbi-re-grow pbi-re-stack-1">
                      <span className="pbi-re-t11 pbi-re-ink-1">{KIND_WORDS.bottom}</span>
                      <button
                        type="button"
                        className="pbi-re-btn pbi-re-wfull pbi-re-t11"
                  ...
                  <div className="pbi-re-row pbi-re-top pbi-re-gap-2" data-lighting-tool="top">
                    <LightArt kind="top" />
                    <div className="pbi-re-grow pbi-re-stack-1">
                      <span className="pbi-re-t11 pbi-re-ink-1">{KIND_WORDS.top}</span>
                      <button
                        type="button"
                        className="pbi-re-btn pbi-re-wfull pbi-re-t11"
                  ...
                  <div className="pbi-re-row pbi-re-top pbi-re-gap-2" data-lighting-tool="top_under">
                    {/* T48-F7: its OWN drawing — it used to borrow `top`'s, which
                        shows a strip washing UP off the carcass. */}
                    <LightArt kind="top_under" />
                    <div className="pbi-re-grow pbi-re-stack-1">
                      <span className="pbi-re-t11 pbi-re-ink-1">{KIND_WORDS.top_under}</span>
                      <button
                        type="button"
                        className="pbi-re-btn pbi-re-wfull pbi-re-t11"
                  ...
                  {unitType?.mount === 'wall' && (
                    <div className="pbi-re-row pbi-re-top pbi-re-gap-2" data-lighting-tool="spot">
                      <LightArt kind="spot" />
                      <div className="pbi-re-grow pbi-re-stack-1">
                        <span className="pbi-re-t11 pbi-re-ink-1">{KIND_WORDS.spot}</span>
                        <button
                          type="button"
                          className="pbi-re-btn pbi-re-wfull pbi-re-t11"
            ...
            <div className="pbi-re-stack-1 pbi-re-pt1 pbi-re-line-t pbi-re-hair" data-scene-light="1">
              <span className="pbi-re-t11 pbi-re-caps pbi-re-track pbi-re-quiet">
                Scene light
              </span>
              <div className="pbi-re-row pbi-re-mid pbi-re-gap-2">
                ...
                />
                <span className="pbi-re-t11 pbi-re-ink-3 pbi-re-w10 pbi-re-right" data-scene-light-read="1">
            ...
            {lighting.items.length > 0 && (
              <div className="pbi-re-stack-1 pbi-re-pt1 pbi-re-line-t pbi-re-hair" data-lighting-items={lighting.items.length}>
                <span className="pbi-re-t11 pbi-re-caps pbi-re-track pbi-re-quiet">
                ...
                {(() => {
                  ...
                  return (
                    <div className="pbi-re-row pbi-re-mid pbi-re-gap-2 pbi-re-pb1" data-lighting-inset-all="1">
                      <span className="pbi-re-t10 pbi-re-quiet pbi-re-nogrow">All strips, off the edge</span>
                      <input
                        type="range"
                        className="pbi-re-grow pbi-re-accent"
                        min={0}
                ...
                {lighting.items.map((it) => {
                  ...
                  return (
                    <div key={it.id} className="pbi-re-t11 pbi-re-ink-1" data-lighting-item={it.id}>
                      ...
                      {it.kind === 'shelf' && strip && (
                        <div className="pbi-re-row pbi-re-mid pbi-re-gap-2 pbi-re-pl1">
                          <input
                            type="range"
                            className="pbi-re-grow pbi-re-accent"
                            min={0}
                          ...
                          />
                          <span className="pbi-re-t10 pbi-re-quiet pbi-re-tnum pbi-re-w14 pbi-re-right">
                            {strip.depth_mm} mm
                          </span>
                        </div>
                      )}
                      ...
                      {it.kind !== 'spot' && it.kind !== 'bottom' && (
                        <div className="pbi-re-row pbi-re-mid pbi-re-gap-2 pbi-re-pl1">
                          <span className="pbi-re-t10 pbi-re-quiet pbi-re-nogrow">Off the front edge</span>
            ...
            <p className="pbi-re-t10 pbi-re-quiet pbi-re-pt1 pbi-re-line-t pbi-re-hair">
        ...
        {/* ─── TURN 51 (CLAUDE.md F6): THE ROOM'S OWN LAMPS ────────────────
            ...
            rig's arithmetic. */}
        <div className="pbi-re-stack-2" data-light-rig="1">
          <div className="pbi-re-fieldrow">
            <span className="pbi-re-t11 pbi-re-caps pbi-re-track pbi-re-quiet">The room</span>
            <span className="pbi-re-grow" />
            <span className="pbi-re-t10 pbi-re-ink-3">
          ...
          <div className="pbi-re-row pbi-re-gap-1 pbi-re-wrap" data-light-presets="1">
            {PRESET_IDS.map((id) => (
              <button
                key={id}
                type="button"
                ...
                className={`pbi-re-btn pbi-re-px2 pbi-re-t11 ${
                  rig.preset === id && matchesPreset(rig) ? 'pbi-re-hair-gold pbi-re-ink' : ''}`}
          ...
          <ul className="pbi-re-stack-1" data-light-lamps="1">
            {RIG_LAMPS.map((id) => {
              const on = rig.lamps[id].on;
              return (
                <li key={id} className="pbi-re-line pbi-re-hair pbi-re-round pbi-re-p2 pbi-re-stack-1" data-light-lamp={id}>
                  <div className="pbi-re-row pbi-re-mid pbi-re-gap-2">
                    <button
                      type="button"
                      ...
                      className={`pbi-re-w11 pbi-re-h6 pbi-re-round pbi-re-line pbi-re-nogrow pbi-re-rel pbi-re-fade ${
                        on ? 'pbi-re-fill-on pbi-re-hair-ok' : 'pbi-re-hair pbi-re-fill-panel'}`}
                      onClick={() => setLightRig({ lamps: { [id]: { ...rig.lamps[id], on: !on } } })}
                    >
                      <span
                        className={`pbi-re-abs pbi-re-top05 pbi-re-w4 pbi-re-h4 pbi-re-round pbi-re-fade-all ${
                          on ? 'pbi-re-left6 pbi-re-fill-ground' : 'pbi-re-left05 pbi-re-fill-quiet'}`}
                      />
                    </button>
                    <span className="pbi-re-tsm pbi-re-ink pbi-re-grow">{RIG_LABELS[id]}</span>
                    <span className="pbi-re-t11 pbi-re-quiet pbi-re-tnum pbi-re-w10 pbi-re-right" data-light-strength-read={id}>
                      {on ? `${Math.round(rig.lamps[id].strength * 100)}%` : 'off'}
                    </span>
                  </div>
                  <p className="pbi-re-t10 pbi-re-ink-3 pbi-re-lead-snug">{RIG_HINTS[id]}</p>
                  <input
                    type="range"
                    className="pbi-re-wfull"
          ...
          <p
            className="pbi-re-t10 pbi-re-px2 pbi-re-py1 pbi-re-round pbi-re-line pbi-re-hair-gold-soft pbi-re-fill-gold-wash pbi-re-ink-3 pbi-re-lead-snug"
