...
export default function RoomModal({
  ...
  return (
    ...
    >
      ...
      <div className="pbi-re-stack-3" data-room-door={wizard ? 'wizard' : 'menu'} data-room-one-window="1">
      <div className="pbi-re-grid pbi-re-grid-2 pbi-re-gap-4" data-room-plan-half="1">
        {/* ── plan ── */}
        <div>
                ...
                <g key={w.stub ? `stub-${w.index}` : w.index}>
                  ...
                  {!w.stub && (
                    <text
                      ...
                      fill={w.index === wallOnShow ? '#806A44' : '#090A09'}
            ...
            {shown.filter((w) => !w.stub).map((w) => {
              ...
              return (
                <line
                  key={`grab-${w.index}`}
                  x1={a.x} y1={a.y} x2={b.x} y2={b.y}
                  stroke={on || here ? '#806A44' : 'transparent'}
            ...
            {shown.filter((w) => !w.stub).map((w) => {
              ...
              return (
                <g key={`corner-${w.index}`} data-low-corner={w.index} data-low-corner-mm={h.start}>
                  <circle cx={a.x} cy={a.y} r={4} fill="none" stroke="#806A44" strokeWidth="1.5" />
                  <text x={a.x + 6} y={a.y - 6} fill="#806A44" fontSize="9">{formatMm(h.start)}</text>
                </g>
              );
            })}
      ...
      <div className="pbi-re-line-t pbi-re-hair pbi-re-pt3" data-elevation-dock="1" data-elevation-wall={wallOnShow}>
        <div className="pbi-re-fieldrow pbi-re-mb2">
          <span className="pbi-re-txs pbi-re-caps pbi-re-track pbi-re-ink-2">
            Wall {wallOnShow + 1} — the elevation
          </span>
          <span className="pbi-re-t11 pbi-re-quiet">Click a wall in the plan above to change it.</span>
        </div>
        ...
        {impliedHere.map((p) => (
          <p
            ...
            className="pbi-re-t11 pbi-re-ink-3 pbi-re-line pbi-re-hair pbi-re-round pbi-re-px2 pbi-re-py1 pbi-re-mb2"
