...
const MAP = {
  ...
  // The owner: *"przyciski kwadratowe … napisy bardziej posh."* Inter 12px
  // tracked +0.08em uppercase, a hairline in Onyx at 40%
  ...
  //
  // ─── T66 F10 · AND THE CORNER IS NO LONGER ZERO ─────────────────────────
  // The owner chose variant 2 and asked *"wszystkie przyciski będą zmienione,
  // prawda?"* — so `--pbi-control-radius` (8px) replaces T64's zero here as
  // well, and a copied editor's buttons come out of this map wearing exactly
  // the shape `controls.jsx`'s own Button wears. One map, one shape.
  'cc-btn': ['pbi-re-btn', '.pbi-re-btn { padding: 0.5rem 0.75rem; border-radius: var(--pbi-control-radius); font-family: var(--pbi-font-ui); font-size: 12px; line-height: 1; letter-spacing: 0.08em; text-transform: uppercase; border: 1px solid rgba(9, 10, 9, 0.4); background: var(--pbi-ivory); color: var(--pbi-onyx); transition: color 150ms ease, background-color 150ms ease, border-color 150ms ease; }\n.pbi-re-btn:hover:not(:disabled) { border-color: var(--pbi-deep-gold); }\n.pbi-re-btn[aria-pressed="true"], .pbi-re-btn:active { border-color: var(--pbi-deep-gold); box-shadow: inset 0 0 0 1px var(--pbi-deep-gold); }\n.pbi-re-btn:disabled { opacity: 0.4; cursor: not-allowed; }'],
  'cc-btn-gold': ['pbi-re-btn-gold', '.pbi-re-btn-gold { padding: 0.5rem 0.75rem; border-radius: var(--pbi-control-radius); font-family: var(--pbi-font-ui); font-size: 12px; line-height: 1; letter-spacing: 0.08em; text-transform: uppercase; background: var(--pbi-onyx); color: var(--pbi-porcelain); border: 1px solid var(--pbi-onyx); transition: color 150ms ease, background-color 150ms ease, border-color 150ms ease; }\n.pbi-re-btn-gold:hover:not(:disabled) { background: var(--pbi-graphite); border-color: var(--pbi-graphite); }\n.pbi-re-btn-gold:disabled { opacity: 0.4; cursor: not-allowed; }'],
  'cc-btn-ghost': ['pbi-re-btn-ghost', '.pbi-re-btn-ghost { padding: 0.25rem 0.5rem; border-radius: var(--pbi-control-radius); font-family: var(--pbi-font-ui); font-size: 12px; line-height: 1; letter-spacing: 0.08em; text-transform: uppercase; border: 1px solid transparent; background: transparent; color: var(--pbi-deep-gold); transition: color 150ms ease, background-color 150ms ease, border-color 150ms ease; }\n.pbi-re-btn-ghost:hover { color: var(--pbi-onyx); }'],
