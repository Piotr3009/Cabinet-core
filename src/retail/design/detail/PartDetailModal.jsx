...
export default function PartDetailModal() {
  ...
  return (
    <Modal
      ...
      title={(
        <span className="pbi-re-row pbi-re-mid pbi-re-gap-3" data-editor-topbar="1">
          <span className="pbi-re-ink">{`${unit.params.unit_num} · ${elementLabel(panel) || panel.part} — ${panel.id}`}</span>
          <span className="pbi-re-t11 pbi-re-quiet pbi-re-tnum" data-editor-size="1">
            {formatMmPair(panel.w, panel.h, ' × ')} · {formatMm(panel.thickness)} mm
          </span>
          {/* ─── TURN 23 (CLAUDE.md F9.3): THE BADGE ───────────────────────── */}
          {changes > 0 && (
            <span
              className="pbi-re-t10 pbi-re-px15 pbi-re-py05 pbi-re-round pbi-re-line pbi-re-hair-gold pbi-re-gold"
      ...
      fullscreen
    >
      <div className="pbi-re-hfull pbi-re-minh pbi-re-row pbi-re-col" data-editor-shell="1">
        {/* ─── F2: THE TOOLBAR ───────────────────────────────────────────── */}
        <div
          className="pbi-re-row pbi-re-mid pbi-re-gap-1 pbi-re-px2 pbi-re-py1 pbi-re-line-b pbi-re-hair pbi-re-nogrow pbi-re-h34px"
          data-part-tools="1"
          data-editor-toolbar="1"
        >
          {TOOLS.map((g) => (
            <span key={g.group} className="pbi-re-row pbi-re-mid pbi-re-gap-05" data-tool-group={g.group}>
              {g.items.map((t) => (
                <button
                  key={t.id}
                  type="button"
                  className={`pbi-re-btn pbi-re-px15 pbi-re-py05 pbi-re-t13 pbi-re-lead-none ${tool === t.id ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                  data-part-tool={t.id}
              ...
              <span className="pbi-re-wpx pbi-re-h4 pbi-re-fill-line pbi-re-mx1" aria-hidden />
            </span>
          ))}
          ...
          <button
            type="button" className="pbi-re-btn-ghost pbi-re-px15 pbi-re-t11"
            data-part-undo="1"
            disabled={!changes}
          ...
          <button
            type="button" className="pbi-re-btn pbi-re-px15 pbi-re-t11"
          ...
          <div className="pbi-re-rel">
            <button
              type="button"
              className={`pbi-re-btn pbi-re-px2 pbi-re-t11 ${openMenu === 'layers' ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
              data-layers-menu="1"
            ...
            {openMenu === 'layers' && (
              <LayerList
                ...
                className={`pbi-re-abs pbi-re-right0 pbi-re-top-full pbi-re-mt1 ${LAYER_CLASS.panel}`}
              />
            )}
          </div>
          ...
          <div className="pbi-re-rel">
            <button
              type="button"
              className={`pbi-re-btn pbi-re-px2 pbi-re-t11 ${openMenu === 'snap' ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
              data-snap-menu="1"
            ...
            {openMenu === 'snap' && (
              <div
                className={`pbi-re-abs pbi-re-right0 pbi-re-top-full pbi-re-mt1 pbi-re-w44 pbi-re-panel pbi-re-p2 pbi-re-stack-1 ${LAYER_CLASS.panel}`}
                data-snap-panel="1"
                data-snap-dropdown="1"
              >
                {SNAP_KINDS.map((k) => (
                  <label key={k.id} className="pbi-re-row pbi-re-mid pbi-re-gap-15 pbi-re-t11 pbi-re-ink-3" title={k.label}>
                    <input
                      type="checkbox"
                      data-snap-kind={k.id}
                    ...
                    <span className="pbi-re-grow">{k.id}</span>
                    <span className="pbi-re-ink-3">{k.label}</span>
                  </label>
                ))}
                <div className="pbi-re-row pbi-re-gap-1 pbi-re-pt1 pbi-re-line-t pbi-re-hair">
                  <button type="button" className="pbi-re-btn-ghost pbi-re-px1 pbi-re-t11" data-snap-all="1" onClick={() => setAllSnaps(true)}>all</button>
                  <button type="button" className="pbi-re-btn-ghost pbi-re-px1 pbi-re-t11" data-snap-none="1" onClick={() => setAllSnaps(false)}>none</button>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="pbi-re-grow pbi-re-minh pbi-re-rel pbi-re-fill-onyx" data-part-drawing="1" data-editor-canvas="1">
          <PartDrawing
            drawing={drawing}
            hovered={hovered}
            onHover={setHovered}
          ...
          <div
            className={`pbi-re-abs pbi-re-right2 pbi-re-top2 ${LAYER_CLASS.inPanel} w-56`}
            data-layer-overlay="1"
            data-overlay-open={overlayOpen ? '1' : '0'}
          >
            <button
              type="button"
              className="pbi-re-wfull pbi-re-btn pbi-re-px2 pbi-re-py05 pbi-re-t11 pbi-re-row pbi-re-mid pbi-re-gap-1"
              data-layer-overlay-toggle="1"
              onClick={() => setOverlayOpen((was) => !was)}
            >
              <span>Layers</span>
              <span className="pbi-re-grow pbi-re-right pbi-re-quiet">{drawing.legend.length}</span>
          ...
          <div
            className={`pbi-re-abs pbi-re-left2 pbi-re-bottom2 ${LAYER_CLASS.inPanel} pbi-re-round pbi-re-line pbi-re-hair pbi-re-clip`}
            data-part-canvas="1"
            data-thumb-size={THUMB_SIZES[thumb].id}
            style={{
              width: THUMB_SIZES[thumb].w,
              height: THUMB_SIZES[thumb].h,
              background: profile.appearance.room?.background || '#FAF8F3',
            }}
          ...
          {askLayer && (
            <div
              className={`pbi-re-abs pbi-re-left-half pbi-re-shift-half pbi-re-top2 pbi-re-panel pbi-re-p2 pbi-re-row pbi-re-mid pbi-re-gap-2 ${LAYER_CLASS.panel}`}
              data-layer-ask="1"
            >
              <span className="pbi-re-t11 pbi-re-ink-1 pbi-re-nogrow" data-layer-ask-prompt="1">
                Which layer should these go on?
              </span>
              <select
                className="pbi-re-input pbi-re-w48"
              ...
              <button
                type="button"
                className="pbi-re-btn-gold pbi-re-px3"
                data-layer-ask-ok="1"
        ...
        <div
          ...
          className="pbi-re-nogrow pbi-re-row pbi-re-mid pbi-re-gap-3 pbi-re-px2 pbi-re-py1 pbi-re-line-t pbi-re-hair pbi-re-t11 pbi-re-quiet pbi-re-h30px"
          data-editor-status="1"
        >
          <span className="pbi-re-tnum pbi-re-w40" data-status-cursor="1">
            {cursor ? `x ${formatMm(cursor.x)}  y ${formatMm(cursor.y)}` : 'x —  y —'}
          </span>
          <span data-status-snap={snapNow || ''}>
            snap {snapNow || '—'}
            <span className="pbi-re-ink-3"> ({activeSnaps.length}/{SNAP_KINDS.length})</span>
          </span>
          ...
          <span className="pbi-re-grow pbi-re-right pbi-re-ink-3" data-part-note="1" data-part-prompt="1">
            {status || note || promptFor({
              tool, spec, pending, picked, selected,
            })}
          </span>
          <span className="pbi-re-ink-3" data-part-orientation={drawing.size.rotated ? 'turned' : 'upright'}>
          ...
          {tool === 'dowels' && (
            <>
              <span className="pbi-re-quiet">pitch</span>
              <NumberField
...
function LayerList({
  ...
  return (
    <div className={`pbi-re-panel pbi-re-p15 pbi-re-maxh45vh pbi-re-scroll pbi-re-scrollbox ${className}`} data-part-legend="1" data-layer-list="1">
      <ul className="pbi-re-stack-05">
        {rows.map((l) => (
          <li key={l.name}>
            <div
              className={`pbi-re-wfull pbi-re-row pbi-re-mid pbi-re-gap-15 pbi-re-px1 pbi-re-py05 pbi-re-round pbi-re-left pbi-re-fill-hover ${
                active === l.name ? 'pbi-re-fill-soft' : ''}`}
              data-legend-layer={l.name}
              data-layer-active={active === l.name ? '1' : undefined}
              data-layer-user={l.user ? '1' : undefined}
            >
              <span className="pbi-re-w3 pbi-re-h3 pbi-re-round pbi-re-nogrow pbi-re-line pbi-re-hair-onyx40" style={{ background: l.screen }} />
              <button
                type="button"
                className="pbi-re-t11 pbi-re-ink-1 pbi-re-grow pbi-re-trunc pbi-re-left"
                title={`Draw on ${l.name}`}
                onClick={() => onPick(l.name)}
              >
                {l.name}
              </button>
              <span className="pbi-re-t10 pbi-re-quiet pbi-re-tnum pbi-re-w5 pbi-re-right">{counts.get(l.name) || 0}</span>
              <button
                type="button"
                className="pbi-re-t10 pbi-re-quiet pbi-re-w4"
      ...
      {/* ─── F3: + NEW LAYER ─────────────────────────────────────────────── */}
      {newLayer ? (
        <div className="pbi-re-mt1 pbi-re-pt1 pbi-re-line-t pbi-re-hair pbi-re-stack-1" data-new-layer="1">
          <input
            className="pbi-re-input pbi-re-wfull pbi-re-t11"
          ...
          />
          <div className="pbi-re-row pbi-re-wrap pbi-re-gap-1" data-new-layer-colours="1">
            {USER_LAYER_COLOURS.map((c) => (
              <button
                key={c.aci}
                type="button"
                className={`pbi-re-w4 pbi-re-h4 pbi-re-round pbi-re-line ${newLayer.aci === c.aci ? 'pbi-re-hair-gold' : 'pbi-re-hair-onyx40'}`}
          ...
          {fault && <p className="pbi-re-t10 pbi-re-bad" data-new-layer-fault="1">{fault}</p>}
          <div className="pbi-re-row pbi-re-gap-1">
            <button type="button" className="pbi-re-btn-gold pbi-re-px2 pbi-re-t11" data-new-layer-add="1" onClick={onAdd}>Add</button>
            <button type="button" className="pbi-re-btn-ghost pbi-re-px2 pbi-re-t11" onClick={() => onNewLayer(null)}>Cancel</button>
          </div>
        </div>
      ) : (
        <button
          type="button"
          className="pbi-re-mt1 pbi-re-wfull pbi-re-btn-ghost pbi-re-px1 pbi-re-t11 pbi-re-left"
...
function ObjectMenu({
  ...
  return (
    <>
      <div className="pbi-re-abs pbi-re-inset0" onPointerDown={onClose} />
      <div
        className={`pbi-re-abs pbi-re-panel pbi-re-py1 pbi-re-w36 ${LAYER_CLASS.panel}`}
        data-object-menu="1"
      ...
      >
        {items.map(([id, label]) => (
          <button
            key={id}
            type="button"
            className="pbi-re-wfull pbi-re-left pbi-re-px2 pbi-re-py1 pbi-re-t11 pbi-re-ink-1 pbi-re-fill-hover"
            data-object-verb={id}
            onClick={() => onPick(id)}
          >
            {label}
...
function PartDrawing({
  ...
  const outlineColour = drawing.legend.find((l) => l.name === drawing.outlineLayer)?.colour || '#F2EEE7';
  ...
  return (
    <div ref={wrapRef} className="pbi-re-wfull pbi-re-hfull pbi-re-rel">
      <button
        type="button"
        className={`pbi-re-abs pbi-re-left1 pbi-re-top1 ${LAYER_CLASS.inPanel} pbi-re-btn-ghost pbi-re-t11 pbi-re-px15 pbi-re-py05`}
        data-part-fit="1"
      ...
      <svg
        ref={svgRef}
        className="pbi-re-wfull pbi-re-hfull"
        style={{
        ...
        <g transform="scale(1 -1)">
          ...
          {drawing.machinings.map((m) => {
            ...
            const common = {
              ...
              ...(picked === m.id ? { 'data-picked': '1', strokeWidth: 3.4, stroke: '#D2C19F' } : {}),
            };
            ...
            {measures.map((m, i) => (
              ...
              <g key={`m${i}`} data-measure={i}>
                <line
                  ...
                  stroke="#B8A588" strokeWidth={1.4} vectorEffect="non-scaling-stroke" strokeDasharray="2 3"
                />
                <text
                  x={(m.from.x + m.to.x) / 2}
                  y={(m.from.y + m.to.y) / 2}
            ...
            {objects.filter((o) => selected.includes(o.id)).map((o) => {
              ...
              return (
                <rect
                  ...
                  fill="none" stroke="#D2C19F" strokeDasharray="3 2" strokeWidth={1}
                  vectorEffect="non-scaling-stroke"
                />
              );
            })}
      ...
      {typed !== null && (
        <div
          className={`pbi-re-abs ${LAYER_CLASS.panel} pbi-re-row pbi-re-mid pbi-re-gap-1 pbi-re-round pbi-re-line pbi-re-hair-gold pbi-re-fill-panel pbi-re-px1 pbi-re-py05 pbi-re-shadow`}
          data-typed-entry="1"
        ...
        >
          <input
            ...
            autoFocus
            className="pbi-re-input pbi-re-w16 pbi-re-right pbi-re-t12"
            data-typed-value="1"
            value={typed}
          ...
          />
          <span className="pbi-re-t10 pbi-re-quiet">mm</span>
        </div>
      )}
      ...
      {entry && spec?.dims?.length > 0 && (
        <div
          className={`pbi-re-abs ${LAYER_CLASS.panel} pbi-re-round pbi-re-line pbi-re-hair-gold pbi-re-fill-panel pbi-re-px15 pbi-re-py1 pbi-re-shadow pbi-re-row pbi-re-mid pbi-re-gap-1`}
        ...
        >
          {spec.dims.map((key, i) => {
            ...
            return (
              <label key={key} className="pbi-re-row pbi-re-mid pbi-re-gap-1 pbi-re-t10 pbi-re-quiet">
                <span className={i === entry.active ? 'pbi-re-gold' : ''}>{key}</span>
                <input
                  // eslint-disable-next-line jsx-a11y/no-autofocus -- the box IS the gesture
                  autoFocus={i === entry.active}
                  ref={(el) => { dimRefs.current[i] = el; }}
                  className={`pbi-re-input pbi-re-w14 pbi-re-right pbi-re-t12 ${i === entry.active ? 'pbi-re-hair-gold' : ''}`}
                  data-dim-field={key}
      ...
      {drillPopover && (
        <div
          className={`pbi-re-abs ${LAYER_CLASS.panel} pbi-re-round pbi-re-line pbi-re-hair-gold pbi-re-fill-panel pbi-re-p2 pbi-re-stack-1 pbi-re-shadow`}
          data-drill-popover="1"
          data-drill-at={`${drillPopover.at.x},${drillPopover.at.y}`}
          style={floatAt(screen, px, 230, 108)}
        >
          <div className="pbi-re-t11 pbi-re-ink-2">This session’s hole</div>
          <div className="pbi-re-fieldrow">
            <span className="pbi-re-t11 pbi-re-quiet pbi-re-w8">⌀</span>
            <NumberField
              className="pbi-re-input pbi-re-w16 pbi-re-right"
              data-drill-d="1"
            ...
            />
            <span className="pbi-re-t11 pbi-re-quiet">deep</span>
            <NumberField
              className="pbi-re-input pbi-re-w16 pbi-re-right"
              data-drill-depth="1"
          ...
          <div className="pbi-re-fieldrow">
            <span className="pbi-re-t10 pbi-re-quiet pbi-re-grow">0 deep = through</span>
            <button
              type="button"
              className="pbi-re-btn-gold pbi-re-px2"
...
function SnapGlyph({ marker }) {
  ...
  return <svg {...box} className="pbi-re-inline pbi-re-valign-mid pbi-re-gold">{inner()}</svg>;
}
