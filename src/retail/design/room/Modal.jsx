...
export default function Modal({
  title, onClose, children, footer, width = 'pbi-re-w420',
  ...
  return (
    <div
      className={`pbi-re-fixed pbi-re-inset ${LAYER_CLASS.modal} ${darken && !sticky ? 'pbi-re-scrim' : ''} ${sticky ? 'pbi-re-noptr' : ''}`}
    ...
    >
      <div
        ...
        className={`pbi-re-fixed pbi-re-panel pbi-re-ptr ${big ? '' : `${width} ${dock ? '' : 'pbi-re-maxh'}`} pbi-re-row pbi-re-col pbi-re-lift ${className}`}
        style={full ? {
      ...
      >
        <div
          className={`pbi-re-row pbi-re-mid ${fullscreen && big ? 'pbi-re-px3 pbi-re-py15' : 'pbi-re-px4 pbi-re-py25'} pbi-re-line-b pbi-re-hair pbi-re-noselect ${big ? '' : 'pbi-re-grab'}`}
        ...
        >
          ...
          {onBack && !big && (
            <button
              type="button"
              className="pbi-re-btn-ghost pbi-re-mr2 pbi-re-nogrow"
              data-modal-back="1"
          ...
          <h2 className="pbi-re-tsm pbi-re-ink">{title}</h2>
          <span className="pbi-re-grow" />
          {onBack && big && (
            <button
              type="button"
              className="pbi-re-back pbi-re-nogrow"
              data-modal-back="1"
        ...
        <div className={`${fullscreen && big ? 'pbi-re-p0 pbi-re-clip' : 'pbi-re-p4 pbi-re-scroll'} pbi-re-grow pbi-re-minh`}>{children}</div>
        ...
        {footer && !covered && (
          <div className="pbi-re-px4 pbi-re-py3 pbi-re-line-t pbi-re-hair pbi-re-row pbi-re-end pbi-re-gap-2" data-modal-footer="1">{footer}</div>
        )}
      </div>
    </div>
  );
