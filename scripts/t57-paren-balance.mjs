 ...
 * between TWO COMMITS, and an untracked file on disk tonight is none of that
 * window's business — which is what lets turn 57's own guard go on asserting
 * turn 57's claim after turn 58 has legitimately amended a different kit.
 * A claim about a finished turn is a fact about two commits.
 */
