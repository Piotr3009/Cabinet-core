...
//
// CLAUDE.md names this path: *"`verify/t64/t64-classify.mjs` proving zero
...
// `scripts/t64-classify.mjs`, and this is the path the spec named, forwarding
// its own arguments so `node verify/t64/t64-classify.mjs --probe` does exactly
...
const script = new URL('../../scripts/t64-classify.mjs', import.meta.url).pathname;
