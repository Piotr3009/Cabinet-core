...
export default function JpullRunModal() {
  ...
  return (
    <Modal
      ...
      width="w-[300px]"
    >
      <div className="space-y-2" data-jpull-run-modal={panel.id}>
        <div className="flex items-center gap-2">
          <span className="cc-label flex-1">J run length</span>
          <NumberField
        ...
        <p className="text-[11px] text-ink-400" data-jpull-run-bounds={`${MIN_RUN_MM}-${max}`}>
