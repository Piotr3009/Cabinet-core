...
const CLASSES = [
  ...
  // T54-F7: the shoe box's two classes (SHOE_GROOVE_6MM, SHOE_RUNNER_5MM)
  // died with their world — the shoe is a standard drawer and its machining
  // is the drawer's own (licence 2; the grave is named in the verdict).
  {
    layer: 'UNIT_NUMBER',
    draw: false,
