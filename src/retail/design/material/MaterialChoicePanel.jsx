...
export default function MaterialChoicePanel({
  ...
  return (
    <div
      className="pbi-re-line pbi-re-hair pbi-re-round pbi-re-p3 pbi-re-stack-3 pbi-re-wfull"
      data-material-panel={slotId}
      data-material-picker-kind={picker || 'none'}
    >
      <div>
        <span className="pbi-re-block pbi-re-t11 pbi-re-caps pbi-re-track16 pbi-re-gold">
      ...
      <div ref={slotBox} data-material-slot-box={slotId}>
        {picker ? (
          ...
          <p className="pbi-re-t11 pbi-re-quiet">This source has no picker yet — the board below is the answer.</p>
        )}
      </div>

      {tile && onClear && (
        <button type="button" className="pbi-re-btn-ghost pbi-re-px2" data-decor-clear="1" onClick={onClear}>
          Clear
        </button>
      )}
