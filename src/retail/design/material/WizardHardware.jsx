...
export default function WizardHardware({ audience = 'factory' }) {
  ...
  return (
    <div className="pbi-re-stack-4" data-wizard-hardware="1" data-hardware-audience={audience}>
      {/* ── hinges: the two finishes Blum actually makes ── */}
      <div>
        <span className="pbi-re-block pbi-re-t10 pbi-re-caps pbi-re-track pbi-re-quiet pbi-re-mb1">Hinges (finish)</span>
        <div className="pbi-re-row pbi-re-gap-2" data-hinge-finish="1">
          {HINGE_FINISHES.map(([id, label]) => (
            <button
              key={id}
              type="button"
              className={`pbi-re-btn pbi-re-px3 ${hingeFinish === id ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
        ...
        <p className="pbi-re-t10 pbi-re-quiet pbi-re-mt1">
      ...
      <div>
        <span className="pbi-re-block pbi-re-t10 pbi-re-caps pbi-re-track pbi-re-quiet pbi-re-mb1">Internal metal</span>
        <div className="pbi-re-row pbi-re-gap-2" data-shelf-sleeve="1">
          {INTERNAL_METALS.map(([id, label]) => {
            ...
            return (
              <button
                key={id}
                type="button"
                className={`pbi-re-btn pbi-re-px3 pbi-re-row pbi-re-mid pbi-re-gap-2 ${internal === id ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
                data-metal-option={id}
                onClick={() => setShelfSleeve(id)}
              >
                <span
                  className="pbi-re-w3 pbi-re-h3 pbi-re-round pbi-re-line pbi-re-hair pbi-re-inline"
      ...
      {!retail && (
      <div>
        <span className="pbi-re-block pbi-re-t10 pbi-re-caps pbi-re-track pbi-re-quiet pbi-re-mb1">Soft-close</span>
        <div className="pbi-re-row pbi-re-gap-2">
          {[['soft-close', 'On (standard)'], ['standard', 'Off']].map(([id, label]) => (
            <button
              key={id}
              type="button"
              className={`pbi-re-btn pbi-re-px3 ${(softClose ? 'soft-close' : 'standard') === id ? 'pbi-re-hair-gold pbi-re-gold' : ''}`}
      ...
      {!retail && (
      <div>
        <span className="pbi-re-block pbi-re-t10 pbi-re-caps pbi-re-track pbi-re-quiet pbi-re-mb1">Push-to-open</span>
        <div className="pbi-re-row pbi-re-gap-2" data-push-to-open="1" data-push-locked={lock.locked ? '1' : '0'}>
          {[['T', 'On'], ['S', 'Off']].map(([id, label]) => (
            <button
              ...
              className={`pbi-re-btn pbi-re-px3 ${runnerVariant === id ? 'pbi-re-hair-gold pbi-re-gold' : ''} ${
                lock.locked ? 'pbi-re-dim pbi-re-nope' : ''}`}
              data-push-option={id}
        ...
        {lock.locked ? (
          <p className="pbi-re-t10 pbi-re-warn pbi-re-mt1" data-push-lock-reason="1">{lock.reason}</p>
        ) : (
          <p className="pbi-re-t10 pbi-re-quiet pbi-re-mt1">
      ...
      {!retail && (
      <div className="pbi-re-line pbi-re-hair pbi-re-round pbi-re-px25 pbi-re-py2 pbi-re-stack-05" data-plinth-summary="1">
        <span className="pbi-re-block pbi-re-t10 pbi-re-caps pbi-re-track pbi-re-quiet">Plinth</span>
        <p className="pbi-re-t11 pbi-re-ink-2">
