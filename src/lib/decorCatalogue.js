import { parseDecorCatalogue, setDecorCatalogue } from '../engine/decors.js';

// ─── Loading the decor pack (BACKLOG #19) ───
//
// The catalogue is a FILE in the repo (public/decors/egger-decors.json, 85
// decors + 256 px thumbnails), so this is a fetch and nothing more. The engine
// never reaches for the network; it is handed the parsed list and keeps it
// (engine/decors.js setDecorCatalogue).
//
